	...
	return (
		<div className="mt-8 flex flex-col items-center relative overflow-hidden">
			...
			<div className="founding-members flex items-center">
				<img className="each-image first-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/mehedi-kaktarua.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/rana.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/minuddin.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/mehedi-math.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/shanthu.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/boro-miah.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/solaiman.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/kamrul.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/sayem.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/shahadat.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/shanto-dev.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/sobuj.jpeg" alt=""/>
				<img className="each-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/jamirul.jpeg" alt=""/>
				<img className="each-image last-image w-100 h-100 p-1 border-3 border-zinc-300" src="public/assets/founding-members/shariful.jpeg" alt=""/>
			</div>
